    ...
    '/study/': [
      {
        ...
        collapsed: false,
        items: [
          { text: '5.10', link: '/study/teng' },
          { text: 'AST', link: '/study/AST' },
          { text: 'Monorepo实现方式', link: '/study/Monorepo' },
          { text: '白屏检测', link: '/study/check_contain' },
          ...
          { text: '3.24', link: '/study/2025.3.24' },
          { text: '4.11', link: '/study/2025.4.11' },
          { text: '4.25', link: '/study/2025.4.25' },
